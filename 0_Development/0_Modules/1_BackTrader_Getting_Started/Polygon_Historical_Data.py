...
session = boto3.Session(
  aws_access_key_id='264e4594-e4d0-4883-acfd-71cf0c76b988',
  aws_secret_access_key='qkfxp0JUT_a24IQODdlWvZLBs0DIrNtb',
)
...
object_key = 'us_options_opra/trades_v1/2025/03/2025-03-07.csv.gz'
